...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) => subcommand.setName('sync').setDescription('ADMIN: Synchronize emojis: Add missing ones & remove outdated ones from the server.'))
        .addSubcommand((subcommand) => subcommand.setName('delete').setDescription('ADMIN: Delete ALL emojis from the server (requires confirmation).')),
