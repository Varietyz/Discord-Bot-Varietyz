...
interacts with the WOM API to fetch player information, and manages Discord channel updates.</p>
</dd>
...
- [config/constants](#module_config/constants)
    ...
    - [~WOMApiConfig](#module_config/constants..WOMApiConfig) : <code>object</code>
...
**Kind**: inner namespace of [<code>config/constants</code>](#module_config/constants)  
<a name="module_config/constants..WOMApiConfig"></a>

### config/constants~WOMApiConfig : <code>object</code>

Configuration settings for the Wise Old Man (WOM) API integration.
...
- [modules/functions/player_data_extractor](#module_modules/functions/player_data_extractor)
    ...
    - [~fetchWithRetry(url, headers, [retries], [delay])](#module_modules/functions/player_data_extractor..fetchWithRetry) ⇒ <code>Promise.&lt;Object&gt;</code>
...
<a name="module_modules/functions/player_data_extractor..fetchWithRetry"></a>

### modules/functions/player_data_extractor~fetchWithRetry(url, headers, [retries], [delay]) ⇒ <code>Promise.&lt;Object&gt;</code>

Makes an HTTP GET request with retry logic.
Handles rate limiting (HTTP 429) and not-found errors (HTTP 404).

**Kind**: inner method of [<code>modules/functions/player_data_extractor</code>](#module_modules/functions/player_data_extractor)  
**Returns**: <code>Promise.&lt;Object&gt;</code> - - The response data from the HTTP request.  
**Throws**:
...
- [modules/utils](#module_modules/utils)
    ...
    - [~respectRateLimit()](#module_modules/utils..respectRateLimit) ⇒ <code>Promise.&lt;void&gt;</code>
...
<a name="module_modules/utils..respectRateLimit"></a>

### modules/utils~respectRateLimit() ⇒ <code>Promise.&lt;void&gt;</code>
